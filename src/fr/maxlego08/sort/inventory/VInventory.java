package fr.maxlego08.sort.inventory;

import java.util.HashMap;
import java.util.Map;

import fr.maxlego08.sort.SortPlugin;
import fr.maxlego08.sort.exceptions.InventoryOpenException;
import fr.maxlego08.sort.zcore.utils.ZUtils;
import fr.maxlego08.sort.zcore.utils.builder.ItemBuilder;
import fr.maxlego08.sort.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.sort.zcore.utils.inventory.ItemButton;
...
public abstract class VInventory extends ZUtils implements Cloneable {
	...
	protected InventoryResult preOpenInventory(SortPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(SortPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, SortPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, SortPlugin plugin, Player player) {
	}
