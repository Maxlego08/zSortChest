package fr.maxlego08.sort.command;
...
import fr.maxlego08.sort.zcore.utils.commands.Arguments;
import fr.maxlego08.sort.zcore.utils.commands.CollectionBiConsumer;
import fr.maxlego08.sort.zcore.utils.commands.CommandType;
import fr.maxlego08.sort.zcore.utils.commands.Tab;
...
public abstract class VCommand extends Arguments {
    ...
    protected final SortPlugin plugin;
    /**
     ...
     */
    public VCommand(SortPlugin plugin) {
        super();
        this.plugin = plugin;
    }
     ...
     */
    public CommandType prePerform(SortPlugin plugin, CommandSender commandSender, String[] args) {
     ...
     * @return the command type.
     */
    protected abstract CommandType perform(SortPlugin plugin);
     ...
     */
    public List<String> toTab(SortPlugin plugin, CommandSender sender, String[] args) {
