...
public enum Message {
    ...
    DESCRIPTION_GIVE("Give sort chest item"),

    COMMANDE_GIVE_RECEIVER("§aYou just got the chest sorter."),
    COMMANDE_GIVE_SENDER("§aYou just gave the chest sorter to the player §f%player%§a."),
