package fr.maxlego08.sort.zcore;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import fr.maxlego08.sort.SortPlugin;
import fr.maxlego08.sort.command.CommandManager;
import fr.maxlego08.sort.command.VCommand;
import fr.maxlego08.sort.listener.AdapterListener;
import fr.maxlego08.sort.zcore.enums.EnumInventory;
import fr.maxlego08.sort.zcore.logger.Logger;
import fr.maxlego08.sort.zcore.utils.gson.LocationAdapter;
import fr.maxlego08.sort.zcore.utils.gson.PotionEffectAdapter;
import fr.maxlego08.sort.zcore.utils.storage.NoReloadable;
import fr.maxlego08.sort.zcore.utils.storage.Persist;
import fr.maxlego08.sort.zcore.utils.storage.Savable;
import fr.maxlego08.sort.exceptions.ListenerNullException;
import fr.maxlego08.sort.inventory.VInventory;
import fr.maxlego08.sort.inventory.ZInventoryManager;
import fr.maxlego08.sort.listener.ListenerAdapter;
import fr.maxlego08.sort.placeholder.LocalPlaceholder;
import fr.maxlego08.sort.placeholder.Placeholder;
import fr.maxlego08.sort.zcore.utils.plugins.Plugins;
...
public abstract class ZPlugin extends JavaPlugin {
    ...
    protected void preEnable() {
        ...
        LocalPlaceholder.getInstance().setPlugin((SortPlugin) this);
        ...
        this.commandManager = new CommandManager((SortPlugin) this);
        this.inventoryManager = new ZInventoryManager((SortPlugin) this);

        /* Add Listener */
        this.addListener(new AdapterListener((SortPlugin) this));
